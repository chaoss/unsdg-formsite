...
To produce the form, a JSON schema is ingested where it transforms each field to a Form.io component. Once the form has been filled out, the `formDataToJson.js` script generates a JSON object based on the schema, capturing all the collected data. This data is then saved to an output file named `code.json`.
...
2. Update value of filePath variable in line 291 of `js/generateFormComponents.js`
...
<!--
## Governance
Information about how the unsdg-formsite community is governed may be found in [GOVERNANCE.md](GOVERNANCE.md).
-->
...
In the spirit of [Executive Order 14028 - Improving the Nation’s Cyber Security](https://www.gsa.gov/technology/it-contract-vehicles-and-purchasing-programs/information-technology-category/it-security/executive-order-14028), a SBOM for this repository is provided here: https://github.com/CHAOSS/unsdg-formsite/network/dependencies.
